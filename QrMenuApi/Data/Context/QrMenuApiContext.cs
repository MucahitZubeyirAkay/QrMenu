...
namespace QrMenuApi.Data.Context
{
    public class QrMenuApiContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.Property(r => r.Name).IsRequired().HasColumnName("nvarchar(200)");
            ...
            {
                entity.Property(ct => ct.Name).IsRequired().HasColumnName("nvarchar(50)");
                entity.Property(ct => ct.Description).IsRequired().HasColumnName("nvarchar(200)");
            ...
            {
                entity.Property(f => f.Name).IsRequired().HasColumnName("nvarchar(100)");
            ...
            {
                entity.HasIndex(au => au.UserName);
